 ...
 *
 * $Id: ss.c,v 3.1 1998/04/17 16:51:35 skadron Exp $
 *
 * $Log: ss.c,v $
 ...
 *
 * Revision 2.5  1997/11/16 06:54:37  skadron
 * Fixed the list of fu names
 *
 * Revision 2.4  1997/10/15 02:02:35  skadron
 * Minor fix for printing of OP_NA
 *
