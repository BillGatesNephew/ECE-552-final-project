 ...
 *
 * $Id: bitmap.h,v 3.1 1998/04/17 16:51:35 skadron Exp $
 *
 * $Log: bitmap.h,v $
 ...
 *
 * Revision 2.7  1997/09/03 18:26:04  skadron
 * Added BITMAP_COUNT_ONES
 *
 * Revision 2.6  1997/08/27 17:16:53  skadron
 * Fixed buglet in BITMAP_NOT -- there was a stray paren
 *
 * Revision 2.5  1997/08/14 20:54:00  skadron
 * Added BITMAP_PRINT_BITSTR to get better dump functions
 *
 * Revision 2.4  1997/08/06 19:55:21  skadron
...
#define BITMAP_ARR_TYPE(BITS, ARR_SZ, NAME) \
        unsigned int (NAME)[ARR_SZ][BITMAP_SIZE(BITS)]
...
#define BITMAP_PRINT_BITSTR(BMAP, SZ, STREAM)			\
  { int i; for (i=0; i<(SZ); i++) fprintf((STREAM), "%08x", (BMAP)[i]); }
