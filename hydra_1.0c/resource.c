 ...
 *
 * $Id: resource.c,v 3.1 1998/04/17 16:51:35 skadron Exp $
 *
 * $Log: resource.c,v $
 ...
 *
 * Revision 2.4  1997/11/16 06:54:01  skadron
 * Added some debugging code to support infinite fu's
 *
...
#ifdef DEBUG_INFINITE_FU
  extern int infinite_fu;
  assert(!infinite_fu);
#endif
