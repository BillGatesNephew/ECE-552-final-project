...
L236:
	...
	lduh [%o1],%o0
	cmp %o0,25
	be L233,a L233,a L233
	ld [%l1+12],%l1
	ld [%o1+4],%o0
	cmp %o0,%o3
	be L233,a L233,a L233,a L233
	ld [%l1+12],%l1
	ld [%o1+8],%o1
	lduh [%o1],%o0
	cmp %o0,42
	be L233,a L233,a L233,a L233,a L233
	ld [%l1+12],%l1
	ld [%o1+8],%o1
	lduh [%o1],%o0
	cmp %o0,38
	be L234,a L234,a L234,a L234,a L234,a L234
	ld [%l1+16],%o0
	ld [%o1+4],%o1
	ld [%o2+20],%o0
	cmp %o1,%o0
...
L294:
	...
	ld [%o1+4],%o1
	cmp %o1,0
	be L294,a L294,a L294
	ld [%o1+28],%o0
L261:
	ldub [%i0+12],%o0
	cmp %o0,45
	be L265,a L265,a L265,a L265
	ldub [%i0+12],%o0
	b L266
	mov %i0,%l0
L265:
	...
	and %o0,0xff,%o0
	cmp %o0,1
	be L295,a L295,a L295,a L295 L295
	sethi %hi(_void_type_node),%o0
	ld [%i0+20],%o0
	ldub [%o0+12],%o0
	cmp %o0,45
	be L295,a L295,a L295,a L295 L295 L295
	sethi %hi(_void_type_node),%o0
	b L266
	ld [%i0+24],%l0
L295:
...
L409:
	cmp %o0,0
	be L411,a L411 L411
	nop L411 L411,a L411,a L411
	ld [%i0+28],%o0
	ld [%i0+60],%o0
	cmp %o0,0
	be L412,a L412 L412
	nop L412 L412,a L412,a L412 L412
	nop
	ld [%i0+28],%o0
...
L435:
	...
	sethi %hi(8192),%o0
	andcc %o1,%o0,%g0
	be,a L417,a L417 L417
	sethi %hi(_obey_regdecls),%o0
	ld [%o0+%lo(_obey_regdecls)],%o0
	cmp %o0,0
	be,a L436,a L436 L436,a L436
	ld [%i0+24],%o0
L417:
	call _gen_reg_rtx,0
	ld [%i0+28],%o0
	...
	ldub [%i1+12],%o0
	cmp %o0,11
	be,a L437,a L437 L437,a L437,a L437
	ld [%i0+64],%o1
...
L581:
	...
	mov 0,%o2
	cmp %i0,3
	be L585,a L585 L585 L585
	sll %i0,2,%o0
	add %o0,%i0,%o0
	sll %o0,1,%o0
	ld [%l6+16],%o1
	cmp %o1,%o0
	be L629,a L629 L629 L629 L629
	mov %l1,%o0
	ldub [%l1+12],%o0
	cmp %o0,35
	be L584,a L584 L584 L584 L584,a L584
	ld [%l1+8],%o1
L585:
	mov %l1,%o0
L629:
	...
	lduh [%i0],%o0
	cmp %o0,37
	be L630,a L630 L630 L630 L630,a L630 L630
	cmp %o0,30
	call _copy_to_reg,0
	mov %i0,%o0
	mov %o0,%i0
...
L816:
	cmp %l6,%i1
	be,a L878,a L878,a L878 L878,a L878
...
L836:
	...
	srl %o0,16,%o0
	cmp %o0,1
	be,a,a L837,a L837 L837 L837 L837
	mov %i1,%o0
	mov %i2,%o1
	call _optimize_bit_field,0
	mov 0,%o2
...
L846:
	...
	lduh [%o1],%o0
	cmp %o0,35
	be L883 L883,a L883,a L883
	lduh [%l3],%o0
	ld [%o1+4],%o0
	cmp %o0,%l6
	be L883 L883,a L883,a L883,a L883
	lduh [%l3],%o0
	mov %o1,%o0
	call _fixup_memory_subreg,0
	mov %i2,%o1
...
L883:
	...
	srl %o0,16,%o0
	cmp %o0,1
	be L884 L884,a L884,a L884,a L884,a L884
	lduh [%l2],%o0
	ld [%l3+4],%o1
	lduh [%o1],%o0
	cmp %o0,35
	be L884 L884,a L884,a L884,a L884,a L884,a L884
	lduh [%l2],%o0
	ld [%o1+4],%o0
	cmp %o0,%l6
	be L884 L884,a L884,a L884,a L884,a L884,a L884,a L884
	lduh [%l2],%o0
	mov %o1,%o0
	call _fixup_memory_subreg,0
	mov %i2,%o1
...
L884:
	...
	srl %o0,16,%o0
	cmp %o0,1
	be L885 L885,a L885,a L885,a L885,a L885,a L885,a L885,a L885
	lduh [%l3],%o0
	ld [%l2+4],%o1
	lduh [%o1],%o0
	cmp %o0,37
	be L885 L885,a L885,a L885,a L885,a L885,a L885,a L885,a L885,a L885
	lduh [%l3],%o0
	ldub [%o1+2],%o0
	cmp %o0,1
	be,a L885
...
L853:
	cmp %l1,%l6
L888:
	be L891 L891 L891 L891
	cmp %l0,%l6
	ld [%i1+8],%o1
	lduh [%o1],%o0
	cmp %o0,35
	be L891 L891 L891 L891 L891
	cmp %l0,%l6
	mov %o1,%o0
	call _fixup_memory_subreg,0
	mov %i2,%o1
	...
	cmp %l0,%l6
L891:
	be L893 L893 L893 L893 L893 L893
	mov %i1,%o0
	ld [%i1+4],%o1
	lduh [%o1],%o0
	cmp %o0,35
	be L893 L893 L893 L893 L893 L893 L893
	mov %i1,%o0
	mov %o1,%o0
	call _fixup_memory_subreg,0
	mov %i2,%o1
...
L893:
	...
	mov %o0,%i0
L890:
	be L878 L878 L878 L878 L878 L878 L878 L878
	sethi %hi(_rtx_format),%o0
	ld [%i1+4],%i0
	lduh [%i0],%o0
	cmp %o0,36
...
_walk_fixup_memory_subreg:
	...
	!#PROLOGUE# 1
	cmp %i0,0
	bg,a L904,a L904,a L904
	lduh [%i0],%o1
	b L916
	mov 0,%i0
L904:
	cmp %o1,35
	bg,a L918,a L918,a L918 L918
	sethi %hi(_rtx_format),%o0
	ld [%i0+4],%o0
	lduh [%o0],%o0
	cmp %o0,37
	bg,a L918,a L918,a L918 L918 L918
	sethi %hi(_rtx_format),%o0
	mov %i0,%o0
	call _fixup_memory_subreg,0
	mov %i1,%o1
...
_fixup_stack_1:
	...
	lduh [%l1],%o0
	cmp %o0,44
	bg,a,a L936 L936 L936
	sethi %hi(_frame_pointer_rtx),%o0
	ld [%l1+4],%o1
	ld [%o0+%lo(_frame_pointer_rtx)],%o0
	cmp %o1,%o0
	bg,a,a L936 L936 L936 L936
	nop
	ld [%l1+8],%o0
	lduh [%o0],%o0
	cmp %o0,30
...
L977:
	...
	cmp %o0,35
L978:
	be L980 L980,a L980,a L980
	ld [%l0+4],%o1
	ld [%o1+4],%o1
	lduh [%o1],%o0
	cmp %o0,37
	be L980 L980,a L980,a L980,a L980
	ld [%l0+4],%o1
L973:
	b L947
	mov %o1,%l2
L980:
	lduh [%o1],%o0
	cmp %o0,35
	be L981 L981,a L981,a L981,a L981 L981
	cmp %l2,0
	cmp %i2,0
	be L981
	cmp %l2,0
...
L1005:
	...
	lduh [%o0],%o0
	cmp %o0,30
	be L1008 L1008,a L1008 L1008 L1008
	mov 1,%l3
	call _size_in_bytes,0
	ld [%l6+52],%o0
	mov 0,%o1
...
L1037:
	cmp %o0,0
	be L1039 L1039 L1039 L1039 L1039
	mov 64,%o0
	sethi %hi(_integer_zero_node),%o1
	call _genop,0
	ld [%o1+%lo(_integer_zero_node)],%o1
...
L1120:
	cmp %o0,0
	be L1041 L1041 L1041 L1041 L1041,a L1041
	ld [%fp-28],%o0
	mov 30,%o0
	mov 0,%o1
	call _gen_rtx,0
...
L1082:
	cmp %i1,26
	bg L1086,a L1086 L1086
	sethi %hi(_obey_regdecls),%o0
	lduh [%l5],%o0
	cmp %o0,34
	bg L1090,a L1090 L1090,a L1090
	st %l4,[%l6+64]
	cmp %l4,0
	bg L1088,a L1088 L1088,a L1088 L1088
	nop
	ldub [%l5+2],%l0
	call _int_size_in_bytes,0
	ld [%l6+8],%o0
...
L1133:
	...
	lduh [%l5],%o0
	cmp %o0,37
	bl,a L1134 L1134,a L1134
	ld [%l6+8],%o0
	ld [%fp-28],%o0
	cmp %o0,0
	bl,a L1134 L1134,a L1134,a L1134
	ld [%l6+8],%o0
	call _get_last_insn,0
	nop
	call _get_last_insn,0
...
L1134:
	ldub [%o0+12],%o0
	cmp %o0,11
	bl,a L1135 L1135,a L1135,a L1135,a L1135
	ld [%l6+12],%o1
	call _mark_reg_pointer,0
	mov %l3,%o0
	b L1135
...
L1177:
	cmp %l0,0
	be,a L1178,a L1178,a L1178,a L1178
	ldub [%l0+12],%o0
	ld [%i0+24],%i0
L1176:
	cmp %i0,0
